...
- **MUST** include docstrings for all public modules,functions, classes, and methods
...
- Use `pip` for fast package management and dependency resolution
...
**Remember:** Prioritize clarity,simplicity and maintainability over cleverness.